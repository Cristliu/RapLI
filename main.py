...
def main():
    ...
    print(dataset[0].keys())#TypeError: 'NoneType' object is not subscriptable
    ...
    # ----- 3). Generate candidate replacement words for sensitive tokens and randomly replace --- #
            ...
            # print("Noise Adder Time:", noise_adder_times)
            ...
            # Collect results
            result = {### For mednli, also need to add hypothesis
                "text": text,
